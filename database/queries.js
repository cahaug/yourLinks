...
module.exports = { 
    ...
    mostPop(){
        return knex('pageViews').distinct('pageViews.listId').count().groupBy('pageViews.listId').join('lists', 'pageViews.listId', 'lists.listId').select('lists.customURL', 'pageviews.listId')
    },
